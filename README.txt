...
This mod changes the color of all HD Chinese tanks from their default light-teal to a tannish-brown color. 
Included are skins for all HD Chinese vehicles and matching icons for the garage and tech tree.

To install:
- Drag the "CWW-RecolorPack-Chinese-BrownDrab" folder from the included "MAIN MOD (Install this FIRST)" folder to your "mods" folder within the World of Tanks install directory (by default, C:\Games\World_of_Tanks\mods\<version>) (example: C:\Games\World_Of_Tanks\mods\1.2.0.1).
